#ifndef BXC_RTSPSERVER_RTSPCONNECTION_H
#define BXC_RTSPSERVER_RTSPCONNECTION_H
#include <string>
#include <map>
...
private:
    ...
    std::string mPeerIp;
    Method mMethod;
    std::string mUrl; //请求的URL。
    std::string mSuffix;//URL的后缀。
    uint32_t mCSeq;
...
#endif //BXC_RTSPSERVER_RTSPCONNECTION_H